...
The independent project for module 5 is under nppi_sobel folder that demonstrate how to do Sobel filter using NVIDIA Performance Primitive (NPP) library.
